...
/**
 * Api services for the `Jadwal` model.
 */
@Injectable()
export class JadwalApi extends BaseLoopBackApi {
   ...
   * This usually means the response is a `Jadwal` object.)
   * </em>
   */
  ...
  /**
   * Statistical information for jadwal registers.
   *
