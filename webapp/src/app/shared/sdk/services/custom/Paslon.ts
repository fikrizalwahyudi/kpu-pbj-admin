...
/**
 * Api services for the `Paslon` model.
 */
@Injectable()
export class PaslonApi extends BaseLoopBackApi {
   ...
   * This usually means the response is a `Paslon` object.)
   * </em>
   */
  ...
  /**
   * Fetches belongsTo relation calon.
   *
   * @param {any} id paslon id
   *
   * @param {boolean} refresh 
   ...
   * </em>
   */
  public getCalon(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/paslons/:id/calon";
    let _routeParams: any = {
  ...
  /**
   * Fetches belongsTo relation wakil.
   *
   * @param {any} id paslon id
   *
   * @param {boolean} refresh 
   ...
   * </em>
   */
  public getWakil(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/paslons/:id/wakil";
    let _routeParams: any = {
  ...
  /**
   * Statistical information for paslon registers.
   *
