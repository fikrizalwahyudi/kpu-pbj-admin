...
/**
 * Api services for the `Pendidikan_terakhir` model.
 */
@Injectable()
export class Pendidikan_terakhirApi extends BaseLoopBackApi {
   ...
   * This usually means the response is a `Pendidikan_terakhir` object.)
   * </em>
   */
   ...
   *
   * @param {any} id pendidikan_terakhir id
   *
   * @param {object} data Request data.
   *
  ...
  public myRemote(customHeaders?: Function): Observable<any> {
    ...
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/pendidikan_terakhirs/my-remote";
    let _routeParams: any = {};
    let _postBody: any = {};
    let _urlParams: any = {};
    let result = this.request(_method, _url, _routeParams, _urlParams, _postBody, null, customHeaders);
  ...
  /**
   * Statistical information for pendidikan_terakhir registers.
   *
