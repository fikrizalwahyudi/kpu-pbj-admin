...
export class ProfileApi extends BaseLoopBackApi {
  ...
  /**
   * Fetches belongsTo relation pendidikan_terakhir.
   *
   ...
   * </em>
   */
  public getPendidikan_terakhir(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/profiles/:id/pendidikan_terakhir";
  ...
  /**
   * Statistical information for profile registers.
   *
