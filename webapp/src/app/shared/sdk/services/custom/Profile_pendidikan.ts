...
/**
 * Api services for the `Profile_pendidikan` model.
 */
@Injectable()
export class Profile_pendidikanApi extends BaseLoopBackApi {
   ...
   *
   * @param {any} id profile_pendidikan id
   *
   ...
   * This usually means the response is a `Profile_pendidikan` object.)
   * </em>
   */
  public getProfile(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/profile_pendidikans/:id/profile";
  ...
  /**
   * Statistical information for profile_pendidikan registers.
   *
