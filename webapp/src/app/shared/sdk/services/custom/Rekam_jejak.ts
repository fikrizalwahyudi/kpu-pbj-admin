...
/**
 * Api services for the `Rekam_jejak` model.
 */
@Injectable()
export class Rekam_jejakApi extends BaseLoopBackApi {
  ...
  /**
   * Statistical information for rekam_jejak registers.
   *
